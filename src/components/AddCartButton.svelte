...
<button
  class="relative flex w-full cursor-pointer items-center justify-center rounded-full bg-blue-600 p-4 text-white hover:opacity-90 disabled:cursor-not-allowed"
  type="button"
  {onclick}
  disabled={loading}
  toolname="addToCart"
