...
{#snippet brandLink(linkClass: string, iconClass: string, labelClass: string)}
  <a href="/" class={linkClass}>
    ...
    <span class={labelClass}> BIG UTI </span>
  </a>
{/snippet}
  ...
  <div class="hidden gap-6 md:flex">
    <div class="block w-max">
      {@render brandLink(
        ...
        "flex size-10 items-center justify-center rounded-xl border border-slate-300 bg-black p-1 dark:border-neutral-700",
        "text-sm font-medium text-slate-900 uppercase dark:text-neutral-100",
      )}
    </div>
    <ul
