...
<div class="mb-8 w-full overflow-x-hidden pb-6">
  <h3
    class="mx-auto max-w-screen-2xl px-4 pb-4 text-2xl font-bold text-neutral-100"
  >
    Destaques
  </h3>
  <ul
    class="flex w-screen animate-carousel gap-4 hover:[animation-play-state:paused]"
  >
