...
<dialog
  ...
  class="fixed top-0 z-50 w-full max-w-xl appearance-none rounded-2xl border border-neutral-800 bg-neutral-950 backdrop:bg-black/70 backdrop:backdrop-blur-sm"
>
