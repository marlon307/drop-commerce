...
<section class="mx-auto mb-16 block max-w-screen-2xl px-4">
  <div class="grid gap-4 lg:grid-cols-2">
    <a href="/" class="group/category">
      <span
        class="relative mb-4 flex h-72 overflow-hidden rounded-md border border-slate-200 bg-white group-hover/category:border-blue-800 dark:border-neutral-800 dark:bg-black"
      >
        <img
