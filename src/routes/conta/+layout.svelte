...
>
  ...
  >
    ...
    >
      <a href="/conta" class="flex items-center gap-2 px-3 py-2">
        <svg
          width="15"
          height="15"
          viewBox="0 0 15 15"
    ...
    >
      <a href="/conta/pedidos" class="flex items-center gap-2 px-3 py-2">
        <svg
          width="15"
          height="15"
          viewBox="0 0 15 15"
    ...
    >
      <a href="/conta/endereco" class="flex items-center gap-2 px-3 py-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
