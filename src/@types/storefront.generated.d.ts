...
export type GetCustomerAccessTokenQuery = { customer?: StorefrontTypes.Maybe<{ orders: { edges: Array<{ node: (
          Pick<StorefrontTypes.Order, 'name' | 'orderNumber' | 'financialStatus'>
