...
export type CustomerFragment = (
  Pick<StorefrontTypes.Customer, 'id' | 'firstName' | 'lastName' | 'email' | 'phone' | 'acceptsMarketing'>
...
export type CustomerCreateMutation = { customerCreate?: StorefrontTypes.Maybe<{ customer?: StorefrontTypes.Maybe<(
      Pick<StorefrontTypes.Customer, 'id' | 'firstName' | 'lastName' | 'email' | 'phone' | 'acceptsMarketing'>
      & { metafield?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Metafield, 'value'>> }
    )>, customerUserErrors: Array<Pick<StorefrontTypes.CustomerUserError, 'field' | 'message' | 'code'>> }> };
...
export type CustomerUpdateMutation = { customerUpdate?: StorefrontTypes.Maybe<{ customer?: StorefrontTypes.Maybe<(
      Pick<StorefrontTypes.Customer, 'id' | 'firstName' | 'lastName' | 'email' | 'phone' | 'acceptsMarketing'>
      & { metafield?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Metafield, 'value'>> }
    )>, customerAccessToken?: StorefrontTypes.Maybe<Pick<StorefrontTypes.CustomerAccessToken, 'accessToken'>>, customerUserErrors: Array<Pick<StorefrontTypes.CustomerUserError, 'field' | 'message' | 'code'>> }> };
...
export type GetCustomerAccessTokenQuery = { customer?: StorefrontTypes.Maybe<(
    Pick<StorefrontTypes.Customer, 'id' | 'firstName' | 'lastName' | 'email' | 'phone' | 'acceptsMarketing'>
    & { metafield?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Metafield, 'value'>> }
  )>, collections: { edges: Array<{ node: Pick<StorefrontTypes.Collection, 'handle' | 'title'> }> } };
