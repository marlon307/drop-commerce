...
export type CustomerFragment = Pick<StorefrontTypes.Customer, 'id' | 'firstName' | 'lastName' | 'email' | 'phone' | 'acceptsMarketing'>;
...
export type CustomerCreateMutation = { customerCreate?: StorefrontTypes.Maybe<{ customer?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Customer, 'id' | 'firstName' | 'lastName' | 'email' | 'phone' | 'acceptsMarketing'>>, customerUserErrors: Array<Pick<StorefrontTypes.CustomerUserError, 'field' | 'message' | 'code'>> }> };
...
export type GetCustomerAccessTokenQuery = { customer?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Customer, 'id' | 'firstName' | 'lastName' | 'email' | 'phone' | 'acceptsMarketing'>>, collections: { edges: Array<{ node: Pick<StorefrontTypes.Collection, 'handle' | 'title'> }> } };
